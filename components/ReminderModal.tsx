                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-4">
                        <p className="text-sm text-slate-600">
                            Set a reminder for the transaction with <strong className="text-primary-600">{transaction.customerName}</strong>.
                        </p>
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="reminderDate" className="block text-sm font-medium text-slate-700">Date</label>
                                <input 
                                    type="date" 
                                    id="reminderDate" 
                                    value={date} 
                            ...
                            <div>
                                <label htmlFor="reminderTime" className="block text-sm font-medium text-slate-700">Time</label>
                                <input 
                                    type="time" 
                                    id="reminderTime" 
                                    value={time} 
